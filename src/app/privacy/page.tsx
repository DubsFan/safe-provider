    ...
    <div className="py-16">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 space-y-8 text-text-body">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-text-heading mb-3">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-text-heading mb-3">2. How We Use Your Information</h2>
            <ul className="list-disc list-inside space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-text-heading mb-3">3. Who We Share With</h2>
            <ul className="list-disc list-inside space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-text-heading mb-3">4. Data Retention</h2>
            <ul className="list-disc list-inside space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-text-heading mb-3">5. Your California Privacy Rights (CCPA)</h2>
            <ul className="list-disc list-inside space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-text-heading mb-3">6. Security</h2>
            <ul className="list-disc list-inside space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-text-heading mb-3">7. Children&apos;s Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-text-heading mb-3">8. Changes to This Policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-text-heading mb-3">9. Contact</h2>
            <p>
